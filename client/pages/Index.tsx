        ...
        <div className="relative">
          ...
          <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
            <div className="aspect-[16/10] bg-gradient-to-br from-emerald-200/30 to-emerald-600/20 flex items-center justify-center">
              <svg viewBox="0 0 400 250" className="w-[85%] max-w-[440px] text-emerald-800/80">
                <defs>
                ...
                <rect x="0" y="180" width="400" height="70" fill="rgba(16,24,40,0.04)" />
                <circle cx="330" cy="50" r="22" fill="rgba(234,179,8,0.35)" />
                <g>
                  <polygon points="200,60 110,120 290,120" fill="url(#roof)" />
                  <rect x="130" y="120" width="140" height="90" rx="6" fill="white" stroke="currentColor" strokeOpacity="0.15" />
                  <rect x="185" y="150" width="30" height="60" rx="3" fill="hsl(var(--primary))" />
                  <rect x="145" y="135" width="24" height="22" fill="rgba(16,24,40,0.06)" />
                  <rect x="231" y="135" width="24" height="22" fill="rgba(16,24,40,0.06)" />
                </g>
                <g>
                  <rect x="85" y="165" width="14" height="25" fill="rgba(16,24,40,0.18)" />
                  <circle cx="92" cy="155" r="14" fill="rgba(16,24,40,0.12)" />
                  <rect x="305" y="165" width="14" height="25" fill="rgba(16,24,40,0.18)" />
                  <circle cx="312" cy="150" r="18" fill="rgba(16,24,40,0.12)" />
                </g>
                <path d="M40 210 H360" stroke="currentColor" strokeOpacity="0.1" strokeWidth="6" strokeLinecap="round" />
              </svg>
            </div>
          </div>
        </div>
